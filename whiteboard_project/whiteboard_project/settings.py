import os
"""
Django settings for whiteboard_project project.
...
SECRET_KEY = 'django-insecure-=5-5h#he@4u!4@s@p@v9rp*7wwnd%3z3=v&4f#(dhu*e!29*!)'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'whiteboard/static']
